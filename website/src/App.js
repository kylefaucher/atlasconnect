      ...
      <div className = "topbar">
          ...
          {this.state.isLoggedIn &&
            <div>
             ...
             <button onClick = {this.handleGoogleSignOut} style = {{'display':'inline', 'margin':'15px', 'background':'white', 'border':'solid 1px gainsboro', 'border-radius':'5px'}} >
             Logout
             </button>
           </div>
          }
        ...
        <Router>
          <div className="main-container">
            ...
            <Route path="/create" render={(props)=> <Write currentUser = {this.state.currentUser} />} />
            <Route path="/profile" 
